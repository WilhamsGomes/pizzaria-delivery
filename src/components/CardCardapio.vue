                            ...
                            <div>
                                ...
                                <div class="px-4">
                                    <v-chip-group v-model="item.selectionTamanho"  active-class="border" >
                                        <v-chip @click="priceProduct(item, item.price)">P</v-chip>

                                        <v-chip @click="priceProduct(item, item.price)">M</v-chip>

                                        <v-chip @click="priceProduct(item, item.price)">G</v-chip>
                                    </v-chip-group>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            priceProduct(item, priceMain){
                item.selectionTamanho == 0 ? (item.priceProduct = priceMain) : item.selectionTamanho == 1 ? (item.priceProduct = priceMain + 5) : item.selectionTamanho == 2 ? (item.priceProduct = priceMain + 10) :  item.priceProduct = priceMain
            }
        },
